...
import { getColumnSpanSize, media } from '@/utils'
...
export const Loading = ({ animating, objectLoaded }: Props) => {
...
// prettier-ignore
const Title = styled(props => <H1 {...props} />)<{ $loaded: boolean, $objectLoaded: boolean }>`
  align-items: center;
  color: white;
  display: flex;
  line-height: 72px;
